function slBusDefinitionCommand() 
% SLBUSDEFINITIONCOMMAND initializes a set of bus objects in the MATLAB base workspace 
...
HAL_command_t.HeaderFile = fullfile(codertarget.parrot.internal.getSpPkgRootDir,'include','HAL.h');
HAL_command_t.Description = '';
HAL_command_t.DataScope = 'Imported';
